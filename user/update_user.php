					...
					<table class="mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" pattern='[\+]\d{2}[\(]\d{3}[\)]\d{4}[\-]\d{4}' title='Phone Number (Format: +99(99)9999-9999)'  name="number" value="<?php echo $row['contact_number'];?>" class="form-control form-control-sm" required></div></td>
							</tr>
							<tr>
