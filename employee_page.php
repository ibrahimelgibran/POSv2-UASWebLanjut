...
<html>
<head>
	<title>POS-IEGCODEV1</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<link rel="icon" type="image/png" sizes="180x180" href="images/ieg.png">
	...
	<div class="h-100 " style="background-color:#003285" id="container">
		<div id="header">
			...
			<div class="header_price border p-0">
				...
				<p class="pb-0 mr-2 mb-2" style="float: right; font-size: 40px;" id="totalValue">IDR 0.00</p>
			</div>
		</div>
