<?php 
    ...
    SELECT 
        ...
        products.unit,
        products.min_stocks,
        MAX(delivery.date) as date -- Use MAX to get the latest date
    FROM 
        supplier
    JOIN 
        delivery ON supplier.supplier_id = delivery.supplier_id
    JOIN 
        product_delivered ON delivery.transaction_no = product_delivered.transaction_no
    JOIN 
        products ON products.product_no = product_delivered.product_id
    WHERE 
        supplier.supplier_id = '$id'
    GROUP BY 
        products.product_no, products.product_name, products.sell_price, products.quantity, products.unit, products.min_stocks
    ";
