...
<body>
	<div class="h-100" style="background-color:#003285" id="container">
		<div id="header">
			...
			<div>
				<img class="img-fluid m-2 w-100" src="images/iegcode.png"/>
			</div>
			...
			<div class="header_price border p-0">
				...
				<p class="pb-0 mr-2" style="float: right; font-size: 40px;" id="totalValue">IDR 0.00</p>
			</div>
		</div>
			...
			<div id="table_buttons">
				...
				<small>
					<ul class="text-white justify-content-center">
						<li class="d-flex mb-0">Total (IDR): <p id="totalValue1" class="mb-0 ml-5 pl-3">0.00</p></li>
						<li class="mb-0 mt-0">Discount (IDR): <input style="width: 100px" class="text-right form-control-sm" type="number" name="discount" value="0" min="0" placeholder="Enter Discount" id="discount" ></li>
					</ul>
				</small>
				</div>
			</div>
